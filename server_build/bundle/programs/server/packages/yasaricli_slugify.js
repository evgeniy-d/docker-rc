...
//////////////////////////////////////////////////////////////////////////////////
//                                                                              //
// packages/yasaricli:slugify/chars.js                                          //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
                                                                                //
CHAR_MAP = {                                                                    // 1
    // latin                                                                    // 2
    'À': 'A', 'Á': 'A', 'Â': 'A', 'Ã': 'A', 'Ä': 'A', 'Å': 'A', 'Æ': 'AE',      // 3
    'Ç': 'C', 'È': 'E', 'É': 'E', 'Ê': 'E', 'Ë': 'E', 'Ì': 'I', 'Í': 'I',       // 4
    'Î': 'I', 'Ï': 'I', 'Ð': 'D', 'Ñ': 'N', 'Ò': 'O', 'Ó': 'O', 'Ô': 'O',       // 5
    'Õ': 'O', 'Ö': 'O', 'Ő': 'O', 'Ø': 'O', 'Ù': 'U', 'Ú': 'U', 'Û': 'U',       // 6
    'Ü': 'U', 'Ű': 'U', 'Ý': 'Y', 'Þ': 'TH', 'ß': 'ss', 'à':'a', 'á':'a',       // 7
    'â': 'a', 'ã': 'a', 'ä': 'a', 'å': 'a', 'æ': 'ae', 'ç': 'c', 'è': 'e',      // 8
    'é': 'e', 'ê': 'e', 'ë': 'e', 'ì': 'i', 'í': 'i', 'î': 'i', 'ï': 'i',       // 9
...
//////////////////////////////////////////////////////////////////////////////////
//                                                                              //
// packages/yasaricli:slugify/slugify.js                                        //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
                                                                                //
var defaultReplacement = function(replacement) {                                // 1
  return replacement == '' ? '' : replacement || '-';                           // 2
};                                                                              // 3
                                                                                // 4
slugify = function(string, replacement) {                                       // 5
  var replacement = defaultReplacement(replacement),                            // 6
      out = '';                                                                 // 7
                                                                                // 8
  if (!_.isString(string)) {                                                    // 9
    return '';                                                                  // 10
  }                                                                             // 11
                                                                                // 12
...
/* Exports */
Package._define("yasaricli:slugify", {
  slugify: slugify
});
